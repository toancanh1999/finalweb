...
!function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {render: function () {
        this.$input.combodate(this.options.combodate), "bs3" === a.fn.editableform.engine && this.$input.siblings().find("select").addClass("form-control selectpicker"), this.options.inputclass && this.$input.siblings().find("select").addClass(this.options.inputclass)
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {initTemplate: function () {
        ...
        ~a.inArray(this.input.type, e) && (this.input.$input.addClass("form-control selectpicker"), c && (this.input.options.inputclass = d, this.input.$input.addClass(d)));
